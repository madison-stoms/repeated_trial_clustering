...
pspline.setting <-function(x,knots,p=3,m=2){
...
fbps.cov <-function(data,x = NULL, diag.remove = TRUE, knots, p=3, m=2, lambda = 0, method="L-BFGS-B",lower= -100, upper=100, control=NULL){
